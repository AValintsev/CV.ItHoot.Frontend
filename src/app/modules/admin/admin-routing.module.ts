...
const routs: Routes = [
  {
    ...
    children: [
...

      {
        path: 'proposals',
        loadChildren: () =>
          import('./page/proposal/proposal.module').then((mod) => mod.ProposalModule),
      },
      {
        path: 'archive',
        loadChildren: () =>
      ...
      },
      {
        path: 'clients',
        loadChildren: () =>
          import('./page/clients/clients.module').then((mod) => mod.ClientsModule),
      },
      {
        path: 'users',
        loadChildren: () =>
      ...
      },
      {
        path: 'profile',
        loadChildren: () =>
          import('./page/user-settings/user-settings.module').then((mod) => mod.UserSettingslModule),
      },
