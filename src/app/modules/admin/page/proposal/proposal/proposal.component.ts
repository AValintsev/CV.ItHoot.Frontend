...
export class ProposalComponent implements OnInit {
  ...
  openProposalDialog(): void {
    ...
    dialogRef.afterClosed().subscribe((proposal: ProposalDto) => {
      ...
      this.proposalService.updateProposal(proposal).subscribe(proposal => {
  ...
  openResumeDialog():void{
    ...
    dialogRef.afterClosed().subscribe((resume: SmallResumeDto) => {
      ...
      this.proposalService.updateProposal(this.proposal).subscribe(proposal => {
        this.proposal = proposal;
  ...
  deleteResume(resume:ProposalResumeDto){
    ...
    this.proposal.resumes = this.proposal.resumes.filter((item, index) => index !== id);
    this.proposal.clientId = this.proposal.client.userId;
  ...
  copyClientLink() {
    ...
    selBox.value = window.location.origin+`/account/${this.proposal.client.shortAuthUrl}`;
