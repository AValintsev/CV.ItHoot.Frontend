...
@Component({
  ...
  templateUrl: './proposal-resume-edit-page.component.html',
  styleUrls: ['./proposal-resume-edit-page.component.scss'],
})
export class ProposalResumeEditPage implements OnInit {
  resume: ResumeDto | {} = {};
